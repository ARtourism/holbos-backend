      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-6 img img-2 d-flex justify-content-center align-items-center">
              <img src="../images/alert.gif" width="200" height="200">
            </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="heading-section mb-5 pt-5 pl-md-5">
                      ...
                      <p class="text-center">Sorry, Unfortunately just happened. Please try again action or request after sometimes or contact us!</p>
